...
export default function NestedView({ handleChangeEditSectionName }) {
  ...
  return (
    <>
      ...
      >
        <p>this is NestedView</p>
        {shop.shopContent.map((section) => (
          // Section Dropdown
                ...
                <button
                  onClick={() =>
                    setConfirmationModal({
                      ...
                      text2: "All the shops in this section will be deleted",
                      btn1Text: "Delete",
                      btn2Text: "Cancel",
                    ...
                    <button
                      onClick={() =>
                        setConfirmationModal({
                          ...
                          text2: "This shop will be deleted",
                          btn1Text: "Delete",
                          btn2Text: "Cancel",
                          btn1Handler: () =>
